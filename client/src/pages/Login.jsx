...
export default function Login() {
  ...
  return (
    <div className="min-h-screen bg-[#08080f] flex items-center justify-center p-6 hero-gradient">
      {/* Orbs */}
      <div className="fixed top-1/4 left-1/4 w-64 h-64 bg-emerald-500/[0.06] rounded-full blur-3xl pointer-events-none" />
      <div className="fixed bottom-1/4 right-1/4 w-48 h-48 bg-blue-500/[0.05] rounded-full blur-3xl pointer-events-none" />
      ...
      <div className="w-full max-w-md">
        ...
        >
          <div className="text-center mb-8">
            <h1 className="text-2xl font-bold font-display text-white mb-1.5">Welcome back</h1>
            <p className="text-sm text-slate-500">Sign in to your FinPilot account</p>
          </div>
          ...
          <div className="grid grid-cols-2 gap-3 mb-6">
            {['Google', 'Apple'].map((provider) => (
              <button
                key={provider}
                className="flex items-center justify-center gap-2 py-2.5 rounded-xl bg-white/[0.04] border border-white/[0.08] text-sm text-slate-300 hover:bg-white/[0.08] hover:border-white/[0.14] transition-all"
              >
                {provider === 'Google' ? (
                  ...
                  <svg width="14" height="16" viewBox="0 0 814 1000" fill="currentColor" className="text-slate-300">
